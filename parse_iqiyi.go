...
func (parse *IqiyiParse) SetCall(name string, call CallFunc) {
...
func (parse *IqiyiParse) SetCookies(cookies []*http.Cookie) {
	parse.Cookies = cookies
}

func (parse *IqiyiParse) SetUserAgent(ua string) {
	parse.UA = ua
}
